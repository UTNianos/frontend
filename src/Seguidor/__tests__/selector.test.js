...
describe('Seguidor Selector', () => {
  it('Selector unit test.', () => {
    ...
    // Generar un nuevo estado, de forma que los parametros sean distintos
    // y el selector deba recomputarse.
    const updatedState = updateMaterias(416, 2);
    const newReducedState = reducer(estadoConMaterias, updatedState);
